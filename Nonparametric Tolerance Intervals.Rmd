...
This first post is going to be about a method of constructing Nonparametric Tolerance Intervals with a focus on it's derivation, simulation and application to real data. It is assumed that the reader is familiar with mathematical statistics when it comes to the derivation section.


In particular, 

known as Wilk's Method
